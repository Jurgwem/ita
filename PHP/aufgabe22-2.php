...
<body>
    ...
    <button class="fadeallin">Alle Fade-in</button>
    <button class="fadeallout">Alle Fade-out</button>
    <button class="slidealldown">Alle Slide-down</button>
    <button class="slideallup">Alle Slide-up</button>
